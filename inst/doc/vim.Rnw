...
%\VignetteIndexEntry{HOWTO: Various Import Methods }
...
\author{Laurent}
\begin{document}
\title{Various Import Methods}

\maketitle
\tableofcontents
\section{Introduction}
This document describes briefly how to write import methods for
the \verb+affy+ pacakge. As one might know, the Affymetrix data are
...
in the \verb+affy+ package
 ...
 \subsection{\verb+AffyBatch+ objects}
