...
%\VignetteIndexEntry{HOWTO: custom processing methods in affy}
...
\author{Laurent}
\begin{document}
\title{Processing methods in the package affy}
...
The package vsn adds a normalization method using the mecanism outlined above.
